...
export {
  BURST_JITTER_SIGMA_MILS, MAX_LIVE_PROJECTILES, fireJitterS, isTracer, perturbedLay, shotTimeS,
} from './burst';
export type { BurstLay } from './burst';
export {
  MAX_RICOCHETS, RICOCHET_MAX_ANGLE_DEG, grazingAngleDeg, normalFromHeights,
