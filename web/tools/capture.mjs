...
const WEAPONS = [
  ...
  ['pion2s7', '2s7-pion-203mm', { az: 40, dist: 15, height: 5.0, targetZ: 1.8, aim: [25, 30] }],
  ...
  ['pistol9', 'pistola-9mm', { az: 40, dist: 3.5, height: 1.6, targetZ: 1.0, aim: [25, 15] }],
  ['rifle556', 'fusil-556', { az: 40, dist: 3.5, height: 1.6, targetZ: 1.0, aim: [25, 15] }],
  ['mg762', 'm240-762', { az: 40, dist: 4.0, height: 1.7, targetZ: 1.0, aim: [25, 15] }],
